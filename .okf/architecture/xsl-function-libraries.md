...
| `helper_functions.xsl` | Misc utilities shared across abstract patterns (e.g. object-existence and attribute-presence helpers used by many "verplichte kenmerken" rules), plus `ma:parse-point`/`ma:parse-line`/`ma:parse-area` — GML coordinate-string parsing, memoized per geometry node via lazily-built XPath maps since [geometry-parse-caching](/decisions/geometry-parse-caching.md), used directly by [R.3](/rules/R.3.md), [R.4](/rules/R.4.md), [R.21](/rules/R.21.md), [R.36](/rules/R.36.md) and transitively by [R.20](/rules/R.20.md)/[R.22](/rules/R.22.md)/[R.23](/rules/R.23.md)/[R.25](/rules/R.25.md)/[R.26](/rules/R.26.md)/[R.39](/rules/R.39.md) via `connectivity_functions.xsl`. |
