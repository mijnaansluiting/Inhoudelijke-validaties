...
* [Coord-node coordinate representation costs ~34% vs. array(xs:double)](./coord-representation-array-vs-node) - Benchmark finding that representing parsed coordinates as `Coord` XML element nodes is measurably slower than a flat array-of-doubles representation, independent of caching; not yet acted on.
