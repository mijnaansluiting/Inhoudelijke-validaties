...
* [Memoized geometry parsing](geometry-parse-caching.md) - Why parsing a geometry's raw GML coordinate string is now cached per node, and why R.21 was the dominant remaining cost the connectivity-index fix didn't touch.
