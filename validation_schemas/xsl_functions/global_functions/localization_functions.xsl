<stylesheet xmlns="http://www.w3.org/1999/XSL/Transform"
  ...
  <function name="ma:get-translation-and-replace-placeholders">
    <param name="message_id"/>
    <param name="placeholders" as="xs:string*"/> <!-- sequence of strings -->
    <variable name="translation" select="ma:get-translation($message_id)"/>
    <value-of select="ma:replace-placeholders($translation, $placeholders)"/>
  </function>

  <function name="ma:replace-placeholders">
    <param name="message" as="xs:string"/>
    <param name="placeholders" as="xs:string*"/> <!-- sequence of strings -->
    <variable name="result">
      <call-template name="ma:replace-recursively">
  ...
  <template name="ma:replace-recursively">
    <param name="message" as="xs:string"/>
